...
function CloseSideBar()
	...
	TweenService:Create(Main.SideTabList, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {BackgroundTransparency = 1,Size = UDim2.new(0,150,0,380),Position = UDim2.new(0,10,0.5,22)}):Play()
...
function ArrayFieldLibrary:CreateWindow(Settings)
	...
	TweenService:Create(Main.SideTabList, TweenInfo.new(0, Enum.EasingStyle.Quint), {BackgroundTransparency = 1,Size = UDim2.new(0,150,0,380),Position = UDim2.new(0,10,0.5,22)}):Play()

...
local function LoadConfiguration(Configuration)
	...
	for FlagName, FlagValue in next, Data do
		if RayfieldLibrary.Flags[FlagName] then
			...
			RayfieldLibrary:Notify({Name = "Flag Error", Content = "Rayfield was unable to find '"..FlagName.. "'' in the current script"})
		end
	end
end
...
function RayfieldLibrary:Notify(NotificationConfig)
	spawn(function()
...
function Hide()
	Debounce = true
	RayfieldLibrary:Notify({Name = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping K", Duration = 7})
...
function RayfieldLibrary:CreateWindow(Settings)
			...
			KeyUI.Main.Input.InputBox.FocusLost:Connect(function()
				...
				if KeyFound then 
					...
					if Settings.KeySettings.SaveKey then
						...
						RayfieldLibrary:Notify({Name = "Key System", Content = "The key for this script has been saved successfully"})
					end
				else
	...
	function Window:CreateTab(Name,Image)
		...
		function Tab:CreateParagraph(ParagraphSettings)
			...
			Paragraph.Content.Position = UDim2.new(1, -11, 0.575,0 )
		...
		function Tab:CreateDropdown(DropdownSettings)
			...
			if SearchBar and SearchBar.Input then
	...
	if CEnabled then
		pcall(function()
			if isfile(ConfigurationFolder .. "/" .. CFileName .. ConfigurationExtension) then
				...
				RayfieldLibrary:Notify({Name = "Configuration Loaded", Content = "The configuration file for this script has been loaded from a previous session"})
			end
		end)
	end
end
